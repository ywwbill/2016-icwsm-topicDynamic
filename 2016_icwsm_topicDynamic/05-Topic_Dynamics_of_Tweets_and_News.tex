...
{
\includegraphics[width=0.32\linewidth]{2016_icwsm_topicDynamic/figures/3LDA2TweetsInSt_revised.pdf}
\label{fig:tweets_topics_inst}
}
\subfigure[Tweets out of \stlouis]
{
\includegraphics[width=0.32\linewidth]{2016_icwsm_topicDynamic/figures/3LDA2TweetsOutSt_revised.pdf}
\label{fig:tweets_topics_outst}
}
\subfigure[News]
{
\includegraphics[width=0.32\linewidth]{2016_icwsm_topicDynamic/figures/1STLDANews-2_revised.pdf}
...
{
\includegraphics[width=0.22\linewidth]{2016_icwsm_topicDynamic/figures/4_3_Michael_Brown.pdf}
\label{fig:mb}
}
\subfigure[News Report]
{
\includegraphics[width=0.22\linewidth]{2016_icwsm_topicDynamic/figures/4_4_News_report.pdf}
...
\subfigure[Pray]
{
\includegraphics[width=0.22\linewidth]{2016_icwsm_topicDynamic/figures/4_6_Pray.pdf}
\label{fig:pray}
}
\subfigure[Emotion]
{
\includegraphics[width=0.22\linewidth]{2016_icwsm_topicDynamic/figures/4_7_Emotion.pdf}
\label{fig:emotion}
}
\includegraphics[width=0.5\linewidth]{2016_icwsm_topicDynamic/figures/4_Legend_cut.pdf}
